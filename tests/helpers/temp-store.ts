  ...
  const entry: Entry = {
    frontmatter: {
      ...
      relations: {
        ...
        contradiction_of: fields.relations?.contradiction_of ?? [],
        derived_from: fields.relations?.derived_from ?? [],
        reinforces: fields.relations?.reinforces ?? [],
        caused_by: fields.relations?.caused_by ?? [],
        blocks: fields.relations?.blocks ?? [],
        depends_on: fields.relations?.depends_on ?? [],
        refutes: fields.relations?.refutes ?? [],
      },
      tags: fields.tags ?? [],
